...
package java_bck;
                    // basically in this stage , package default name is file names. 
...
public class upload_data
{
	...
	public static void main(String[] args) 
	{
     ...
     //create connect
		...
		String s="insert into info(name,email,mobile,age) values(?,?,?,?)";// ? ai marks gulo diye value pass hobe java theke sql data base a , ? represent prepareStatement Parameter 
